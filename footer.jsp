...
<footer>
    <div class="footer-grids">
        <div class="container">
            ...
            <div class="col-md-3 footer three">
                ...
                <ul>
                    <li><i class="fa fa-map-marker"></i><p>MBSTU Medical center<span>santosh</span>Tangail 1902 </p><div class="clearfix"></div> </li>
                    <li><i class="fa fa-phone"></i><p>1234567890</p> <div class="clearfix"></div> </li>
                    <li><i class="fa fa-envelope-o"></i><a href="mailto:info@example.com">contact@mbstu.edu.bd</a> <div class="clearfix"></div></li>
                </ul>
            </div>
    ...
    <div class="copy-right-grids">
        <div class="container">
            <div class="copy-left">
                <p class="footer-gd">© 2020 MBSTU medical center. All Rights Reserved | Design by Dept of ICT, MBSTU</p>
            </div>
