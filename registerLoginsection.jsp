        ...
        <div class="container">
            ...
            <div class="login-form-grids">
                ...
                <form>
                    ...
                    <input type="text" placeholder="Student ID...(eg.IT18021)" required=" ">
                    <input type="text" placeholder="Session...(eg.2017-2018)" required=" ">
                    <select id="dept" class="mdb-select md-form" searchable="Search here..">
                        <option value="ict">ICT</option>
                        <option value="textile">TE</option>
